/******/ ;(() => {
            ...
            /***/ (
                ...
                /* harmony export */ __webpack_require__.d(
                    __webpack_exports__,
                    {
                        ...
                        /* harmony export */ eraseRandomCards: () =>
                            /* binding */ eraseRandomCards,
                        /* harmony export */ getCards: () =>
                            /* binding */ getCards,
                        /* harmony export */ getHiddenCards: () =>
                            /* binding */ getHiddenCards,
                        /* harmony export */ getRow: () => /* binding */ getRow,
                        /* harmony export */ totalRandomCards: () =>
                            /* binding */ totalRandomCards,
                        /* harmony export */ watch: () => /* binding */ watch,
                        /* harmony export */
                    }
                )
                /* harmony import */ var _turnCards__WEBPACK_IMPORTED_MODULE_0__ =
                    __webpack_require__(/*! ./turnCards */ './turnCards.ts')
                ...
                function getRow(row, way, level) {
                    ...
                    for (var i = min; i < max; i++) {
                        if (way === 'open') {
                            ...
                            if ((level === 1 && row === 1) || level > 1) {
                                line +=
                                    '<img src="/img/hidden-card.jpg" class="hidden" index="'.concat(
                                        i,
                                        '"></img>'
                                    )
                            }
                            ...
                            if ((level === 1 && row === 1) || level > 1) {
                                if (
                                    _turnCards__WEBPACK_IMPORTED_MODULE_0__.turned2.includes(
                                        totalRandomCards[i]
                                    ) &&
                                    _turnCards__WEBPACK_IMPORTED_MODULE_0__.turned1.includes(
                                        totalRandomCards[i]
                                    )
                                ) {
                                    line += totalRandomCards[i]
  ...
  \******************/
            /***/ (
                ...
                /* harmony export */ __webpack_require__.d(
                    __webpack_exports__,
                    {
                        /* harmony export */ getPageChoiceLevel: () =>
                            /* binding */ getPageChoiceLevel,
                        /* harmony export */ getPageGame: () =>
                            /* binding */ getPageGame,
                        ...
                        /* harmony export */ realTime: () =>
                            /* binding */ realTime,
                        /* harmony export */ seconds: () =>
                            /* binding */ seconds,
                        /* harmony export */ timerId: () =>
                            /* binding */ timerId,
                        /* harmony export */
                    }
                )
                /* harmony import */ var _cards__WEBPACK_IMPORTED_MODULE_0__ =
                    __webpack_require__(/*! ./cards */ './cards.ts')
                /* harmony import */ var _turnCards__WEBPACK_IMPORTED_MODULE_1__ =
                    __webpack_require__(/*! ./turnCards */ './turnCards.ts')
                ...
                function getPageGame(level) {
                    ...
                    page.innerHTML = '\n    '
                        .concat(head(), '\n    ')
                        .concat(
                            (0, _cards__WEBPACK_IMPORTED_MODULE_0__.getCards)(
                                level
                            ),
                            '\n    '
                        )
                    timerId = setTimeout(function () {
                        page.innerHTML = '\n        '
                            ...
                            .concat(
                                (0,
                                _cards__WEBPACK_IMPORTED_MODULE_0__.getHiddenCards)(
                                    level
                                ),
                                '\n        '
                            )
                        ...
                        playAgainButton.addEventListener('click', function () {
                            ...
                            ;(0,
                            _cards__WEBPACK_IMPORTED_MODULE_0__.eraseRandomCards)()
                            getPageGame(level)
                        })
                        ...
                        cards.forEach(function (card) {
                            return card.addEventListener('click', function () {
                                ;(0,
                                _turnCards__WEBPACK_IMPORTED_MODULE_1__.turnCard)(Number(card.attributes[2].value), level)
                            })
                        })
                    }, 5000)
                    var playAgainButton =
  ...
  \**********************/
            /***/ (
                ...
                /* harmony export */ __webpack_require__.d(
                    __webpack_exports__,
                    {
                        /* harmony export */ erasePairs: () =>
                            /* binding */ erasePairs,
                        /* harmony export */ eraseTurned1: () =>
                            /* binding */ eraseTurned1,
                        /* harmony export */ eraseTurned2: () =>
                            /* binding */ eraseTurned2,
                        /* harmony export */ turnCard: () =>
                            /* binding */ turnCard,
                        /* harmony export */ turned1: () =>
                            /* binding */ turned1,
                        /* harmony export */ turned2: () =>
                            /* binding */ turned2,
                        /* harmony export */
                    }
                )
                /* harmony import */ var _cards__WEBPACK_IMPORTED_MODULE_0__ =
                    __webpack_require__(/*! ./cards */ './cards.ts')
                /* harmony import */ var _pages__WEBPACK_IMPORTED_MODULE_1__ =
                    __webpack_require__(/*! ./pages */ './pages.ts')
                ...
                function time(sec, min) {
                    return ''
                        .concat(min.toString().padStart(2, '0'), '.')
                    ...
                    setTimeout(function () {
                        _pages__WEBPACK_IMPORTED_MODULE_1__.page.innerHTML =
                            '\n        '
                                ...
                                .concat(
                                    (0,
                                    _cards__WEBPACK_IMPORTED_MODULE_0__.getRow)(
                                        1,
                                        'process',
                                        level
                                    ),
                        ...
                        var oneMoreButton =
                            document.getElementById('oneMoreButton')
                        oneMoreButton.addEventListener('click', function () {
                            clearTimeout(int)
                            clearTimeout(
                                _pages__WEBPACK_IMPORTED_MODULE_1__.interval
                            )
                            clearTimeout(
                                _pages__WEBPACK_IMPORTED_MODULE_1__.timerId
                            )
                            ;(0,
                            _cards__WEBPACK_IMPORTED_MODULE_0__.eraseRandomCards)()
                            eraseTurned1()
                            ...
                            erasePairs()
                            ;(0,
                            _pages__WEBPACK_IMPORTED_MODULE_1__.getPageGame)(level)
                            status = 'won'
                ...
                function pairs(number, index, level, sec, min) {
                    ...
                    pairsArray[pairIndex].push(
                        Number(
                            _cards__WEBPACK_IMPORTED_MODULE_0__
                                .totalRandomCards[index]
                        )
                    )
                    if (
                ...
                function turnCard(index, level) {
                    ...
                    if (
                        ...
                        var clickCardNumber =
                            turned1.length / 2 + turned2.length / 2
                        _pages__WEBPACK_IMPORTED_MODULE_1__.page.innerHTML =
                            '\n        '
                                .concat(
                                    (0,
                        ...
                        int = setInterval(function () {
                            ...
                            timer_1.textContent = ''
                                .concat(min_1.toString().padStart(2, '0'), '.')
                                .concat(sec_1.toString().padStart(2, '0'))
                        }, 1000)
                        pairs(clickCardNumber, index, level, sec_1, min_1)
                        if (
                            clickCardNumber === cardsToWin &&
                            status === 'won'
                        ) {
                            clearTimeout(int)
                            clearTimeout(
                            ...
                            setTimeout(function () {
                                ...
                                var playAgainButton =
                                    document.getElementById('playAgainButton')
                                var status_box =
                                    document.getElementById('status_box')
                                var cards = document.getElementById('cards')
                                header.style.filter = 'brightness(0.5)'
                                playAgainButton.disabled = true
                                status_box.style.zIndex = '2'
                                ...
                                var oneMoreButton =
                                    document.getElementById('oneMoreButton')
                                oneMoreButton.addEventListener(
                                    'click',
                                    function () {
                                        clearTimeout(int)
                                        clearTimeout(
                                        ...
                                        erasePairs()
                                        ;(0,
                                        _pages__WEBPACK_IMPORTED_MODULE_1__.getPageGame)(
                                            level
                                        )
                                        status = 'won'
                                        playAgainButton.disabled = false
  ...
  \******************/
        __webpack_require__.r(__webpack_exports__)
        /* harmony import */ var _pages__WEBPACK_IMPORTED_MODULE_0__ =
            __webpack_require__(/*! ./pages */ './pages.ts')
